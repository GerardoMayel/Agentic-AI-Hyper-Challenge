...
export function Root_75e00bd9c4166fee677d5a4ff47400a8 () {
...
,),jsx(RadixThemesTextField.Root,{className:"w-full p-3 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-blue-500/20 focus:border-blue-600 transition-all duration-300 bg-white shadow-sm cursor-pointer",css:({ ["type"] : "date" }),max:"2025-07-06",placeholder:"Select deposit date"},)
,),),),),),jsx(
RadixThemesBox,
{},
jsx(
...
{as:"p",className:"text-sm font-semibold text-slate-700 mb-2"},
"Date of Incident *"
,),jsx(RadixThemesTextField.Root,{className:"w-full p-3 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-blue-500/20 focus:border-blue-600 transition-all duration-300 bg-white shadow-sm cursor-pointer",css:({ ["type"] : "date" }),max:"2025-07-06",placeholder:"Select incident date"},)
,),jsx(
RadixThemesFlex,
{align:"start",className:"rx-Stack flex-1",direction:"column",gap:"3"},
jsx(
...
jsx(Root_75e00bd9c4166fee677d5a4ff47400a8,{},)
,),),jsx(
NextHead,
{},
jsx(
